...
def get_form_set(type_opera, form_nbre):
    ...
    if type_opera=="participants":
        ...
        form_set = modelformset_factory(Person, form=PersonForm, fields=(
            'nom_et_prenom', 'sexe', 'contacts', 'quartier_d_habitation',
            'evangelisation', 'accepte_jesus', 
            'whatsapp', 'boss', 'sujets_de_priere', 'temoignages'
            ), extra=form_nbre)
